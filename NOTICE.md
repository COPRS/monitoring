...
- annotation
  - org.jetbrains:annotations
    - Version: 13.0
    - Licence: [Apache License 2.0](https://github.com/JetBrains/java-annotations/blob/master/LICENSE.txt)
    - Source: https://github.com/JetBrains/java-annotations/tree/master/java8

- antlr
  - antlr:antlr
    - Version: 2.7.7
    - Licence: [ANTLR 2 License](https://www.antlr2.org/license.html)
    - Source: https://www.antlr2.org/download/antlr-2.7.7.tar.gz

- argparse4j
  - net.sourceforge.argparse4j:argparse4j
    - Version: 0.7.0
    - Licence: [MIT License](https://github.com/argparse4j/argparse4j/blob/argparse4j-0.7.0/LICENSE.txt)
    - Source: https://github.com/argparse4j/argparse4j/tree/argparse4j-0.7.0

- aspectjweaver
  - org.aspectj:aspectjweaver
    - Version: 1.9.7
    - Licence: [Eclipse Public License - v2.0](https://github.com/eclipse/org.aspectj/blob/V1_9_7/LICENSE)
    - Source: https://github.com/eclipse/org.aspectj/tree/V1_9_7/aspectjweaver

- audience-annotations
  - org.apache.yetus:audience-annotations
    - Version: 0.5.0
    - Licence: [Apache License 2.0](https://github.com/apache/yetus/blob/rel/0.5.0/LICENSE )
    - Source: https://github.com/apache/yetus/tree/rel/0.5.0/audience-annotations-component/audience-annotations

- byte-buddy
  - net.bytebuddy:byte-buddy
    - Version: 1.12.18
    - Licence: [Apache License 2.0](https://github.com/raphw/byte-buddy/blob/byte-buddy-1.12.18/LICENSE)
    - Source: https://github.com/raphw/byte-buddy/tree/byte-buddy-1.12.18/byte-buddy-maven-plugin

- checker-qual
  - org.checkerframework:checker-qual
    - Version: 3.5.0
    - Licence: [MIT License](https://github.com/typetools/checker-framework/blob/checker-framework-3.5.0/checker-qual/LICENSE.txt)
    - Source: https://github.com/typetools/checker-framework/tree/checker-framework-3.5.0/checker-qual

- classmate
  - com.fasterxml:classmate
    - Version: 1.5.1
    - Licence: [Apache License 2.0](https://github.com/FasterXML/java-classmate/blob/classmate-1.5.1/LICENSE)
...
- core
  - com.electronwill.night-config:core
    - Version: 3.6.6
    - Licence: [GNU Lesser General Public License, version 3.0](https://github.com/TheElectronWill/night-config/blob/v3.6.6/LICENSE)
...
- HdrHistogram
  - org.hdrhistogram:HdrHistogram
    - Version: 2.1.12
    - Licence: [Public Domain, per Creative Commons CC0](https://github.com/HdrHistogram/HdrHistogram/blob/HdrHistogram-2.1.12/LICENSE.txt)
...
- HikariCP
  - com.zaxxer:HikariCP
    - Version: 4.0.3
    - Licence: [Apache License 2.0](https://github.com/brettwooldridge/HikariCP/blob/HikariCP-4.0.3/LICENSE)
    - Source: https://github.com/brettwooldridge/HikariCP/tree/HikariCP-4.0.3

- istack-commons-runtime
  - com.sun.istack:istack-commons-runtime
    - Version: 3.0.12
    - Licence: [BSD 3-Clause "New" or "Revised" License](https://github.com/eclipse-ee4j/jaxb-istack-commons/blob/3.0.12/LICENSE.md)
...
- jakarta.activation-api
  - jakarta.activation:jakarta.activation-api
    - Version: 1.2.2
    - Licence: [BSD 3-Clause "New" or "Revised" License](https://github.com/eclipse-ee4j/jaf/blob/1.2.2/LICENSE.md)
...
- jakarta.annotation-api
  - jakarta.annotation:jakarta.annotation-api
    - Version: 1.3.5
    - Licence: [Eclipse Public License - v2.0](https://github.com/eclipse-ee4j/common-annotations-api/blob/1.3.5/LICENSE.md)
    - Source: https://github.com/eclipse-ee4j/common-annotations-api/tree/1.3.5

- jakarta.el-api
  - jakarta.el:jakarta.el-api
    - Version: 5.0.0
    - Licence: [Eclipse Public License - v2.0](https://github.com/jakartaee/expression-language/blob/5.0.0-RELEASE-api/LICENSE.md)
    - Source: https://github.com/jakartaee/expression-language/tree/5.0.0-RELEASE-api

- jakarta.persistence-api
  - jakarta.persistence:jakarta.persistence-api
    - Version: 2.2.3
    - Licence: [Eclipse Public License - v2.0](https://github.com/jakartaee/persistence/blob/master/LICENSE.md)
    - Source: https://github.com/jakartaee/persistence

- jakarta.transaction-api
  - jakarta.transaction:jakarta.transaction-api
    - Version: 1.3.3
    - Licence: [Eclipse Public License - v2.0](https://github.com/jakartaee/transactions/blob/1.3.3/LICENSE.md)
...
- jakarta.xml.bind-api
  - jakarta.xml.bind:jakarta.xml.bind-api
    - Version: 2.3.3
    - Licence: [BSD 3-Clause "New" or "Revised" License](https://github.com/eclipse-ee4j/jaxb-api/blob/2.3.3/LICENSE.md)
    - Source: https://github.com/eclipse-ee4j/jaxb-api/tree/2.3.3

- jandex
  - org.jboss:jandex
    - Version: 2.4.2.Final
    - Licence: [Apache License 2.0](https://github.com/smallrye/jandex/blob/2.4.2.Final/LICENSE.txt)
...
- jopt-simple
  - net.sf.jopt-simple:jopt-simple
    - Version: 5.0.4
    - Licence: [MIT License](https://github.com/jopt-simple/jopt-simple/blob/jopt-simple-5.0.4/LICENSE.txt)
    - Source: https://github.com/jopt-simple/jopt-simple/tree/jopt-simple-5.0.4

- jose4j
  - org.bitbucket.b_c:jose4j
    - Version: 0.7.8
    - Licence: [Apache License 2.0](https://bitbucket.org/b_c/jose4j/src/jose4j-0.7.8/LICENSE)
    - Source: https://bitbucket.org/b_c/jose4j/src/jose4j-0.7.8/

- jsr305
  - com.google.code.findbugs:jsr305
    - Version: 3.0.2
    - Licence: [BSD 2-Clause License](https://github.com/findbugsproject/findbugs/blob/master/findbugs/licenses/LICENSE-jsr305.txt)
    - Source: https://github.com/findbugsproject/findbugs/tree/master/findbugs
    
- jul-to-slf4j
  - org.slf4j:jul-to-slf4j
    - Version: 1.7.36
    - Licence: [MIT License](https://github.com/qos-ch/slf4j/blob/v_1.7.36/LICENSE.txt)
...
- kotlin-stdlib-common
  - org.jetbrains.kotlin:kotlin-stdlib-common
    - Version: 1.6.21
    - Licence: [Apache License 2.0](https://github.com/JetBrains/kotlin/blob/v1.6.21/license/LICENSE.txt)
...
- LatencyUtils
  - org.latencyutils:LatencyUtils
    - Version: 2.0.3
    - Licence: [Public Domain, per Creative Commons CC0](https://github.com/LatencyUtils/LatencyUtils/blob/LatencyUtils-2.0.3/LICENSE)
    - Source: https://github.com/LatencyUtils/LatencyUtils/tree/LatencyUtils-2.0.3

- log4j-api
  - org.apache.logging.log4j:log4j-api
    - Version: 2.17.2
    - Licence: [Apache License 2.0](https://github.com/apache/logging-log4j2/blob/rel/2.17.2/LICENSE.txt)
...
- lz4-java
  - org.lz4:lz4-java
    - Version: 1.8.0
    - Licence: [Apache License 2.0](https://github.com/lz4/lz4-java/blob/1.8.0/LICENSE.txt)
    - Source: https://github.com/lz4/lz4-java/tree/1.8.0

- metrics-core
  - com.yammer.metrics:metrics-core
    - Version: 2.2.0
    - Licence: [Apache License 2.0](https://github.com/infusionsoft/yammer-metrics/blob/v2.2.0/LICENSE)
    - Source: https://github.com/infusionsoft/yammer-metrics/tree/v2.2.0/metrics-core

- metrics-core
  - io.dropwizard.metrics:metrics-core
    - Version: 4.2.12
    - Licence: [Apache License 2.0](https://github.com/dropwizard/metrics/blob/v4.2.12/LICENSE)
...
- scala-collection-compat_2.13
  - org.scala-lang.modules:scala-collection-compat_2.13
    - Version: 2.4.4
    - Licence: [Apache License 2.0](https://github.com/scala/scala-collection-compat/blob/v2.4.4/LICENSE)
...
- scala-java8-compat_2.13
  - org.scala-lang.modules:scala-java8-compat_2.13
    - Version: 1.0.0
    - Licence: [Apache License 2.0](https://github.com/scala/scala-java8-compat/blob/v1.0.0/LICENSE)
    - Source: https://github.com/scala/scala-java8-compat/tree/v1.0.0

- scala-library
  - org.scala-lang:scala-library
    - Version:2.13.9
    - Licence: [Apache License 2.0](https://github.com/scala/scala/blob/v2.13.9/LICENSE)
    - Source: https://github.com/scala/scala/tree/v2.13.9/src/library

- scala-logging_2.13
  - com.typesafe.scala-logging:scala-logging_2.13
    - Version: 3.9.3
    - Licence: [Apache License 2.0](https://github.com/lightbend-labs/scala-logging/blob/v3.9.3/LICENSE)
    - Source: https://github.com/lightbend-labs/scala-logging/tree/v3.9.3

- scala-reflect
  - org.scala-lang:scala-reflect
    - Version: 2.13.6
    - Licence: [Apache License 2.0](https://github.com/scala/scala/blob/v2.13.6/LICENSE)
...
- snakeyaml
  - org.yaml:snakeyaml
    - Version: 1.33
    - Licence: [Apache License 2.0](https://bitbucket.org/snakeyaml/snakeyaml/src/snakeyaml-1.33/LICENSE.txt)
    - Source: https://bitbucket.org/snakeyaml/snakeyaml/src/snakeyaml-1.33/

- snappy-java
  - org.xerial.snappy:snappy-java
    - Version: 1.1.8.4
    - Licence: [Apache License 2.0](https://github.com/xerial/snappy-java/blob/1.1.8.4/LICENSE)
...
- typetools
  - net.jodah:typetools
    - Version: 0.6.2
    - Licence: [Apache License 2.0](https://github.com/jhalterman/typetools/blob/typetools-0.6.2/LICENSE.txt)
...
- zookeeper-jute
  - org.apache.zookeeper:zookeeper-jute
    - Version: 3.6.3
    - Licence: [Apache License 2.0](https://github.com/apache/zookeeper/blob/release-3.6.3/LICENSE.txt)
